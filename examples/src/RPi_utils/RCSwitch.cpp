...
RCSwitch::RCSwitch() {
 ...
 // this->setPulseLength(350);   /default
  this->setPulseLength(330);    // Optimised for arduino
 // this->setPulseLength(463);    // Optimised for other white transmitter
  this->setRepeatTransmit(10);
  this->setReceiveTolerance(70);  // Default is 60.  Stops worksing about 45
  this->setProtocol(1);
}
